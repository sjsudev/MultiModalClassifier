...
#Download the flower data from this link: 
...
extract_dir = '/Developer/MyRepo/ImageClassificationData/flower-photos.zip'
zip_path, _ = urllib.request.urlretrieve(url, extract_dir)
